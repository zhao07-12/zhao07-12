...
- Includes CodeBuddy Code attribution in commit message
...
This plugin is included in the CodeBuddy Code repository. The commands are automatically available when using CodeBuddy Code.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let CodeBuddy analyze your changes and match your repo's commit style
...
- CodeBuddy will analyze the full branch history for the PR description
...
- **Let CodeBuddy draft messages**: The commit message analysis learns from your repo's style

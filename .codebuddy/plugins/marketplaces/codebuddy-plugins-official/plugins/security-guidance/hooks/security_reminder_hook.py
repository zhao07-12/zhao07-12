#!/usr/bin/env python3
"""
Security Reminder Hook for CodeBuddy Code
...
def get_state_file(session_id):
    ...
    return os.path.expanduser(f"~/.codebuddy/security_warnings_state_{session_id}.json")


def cleanup_old_state_files():
    """Remove state files older than 30 days."""
    try:
        state_dir = os.path.expanduser("~/.codebuddy")

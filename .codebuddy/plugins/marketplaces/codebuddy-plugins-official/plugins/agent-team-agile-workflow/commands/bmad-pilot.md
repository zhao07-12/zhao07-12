...
Saving:
1) Ensure directory ./.codebuddy/specs/{feature_name}/ exists
2) Save the scan summary to ./.codebuddy/specs/{feature_name}/00-repo-scan.md
...
- **Directory Creation**: Ensure directory ./.codebuddy/specs/{feature_name}/ exists before any saves (orchestration responsibility)
...
Repository Scan Path: ./.codebuddy/specs/{feature_name}/00-repo-scan.md
...
Your task:
1. Create directory ./.codebuddy/specs/{feature_name}/ if it doesn't exist
2. Save the PRD to ./.codebuddy/specs/{feature_name}/01-product-requirements.md
...
Your task:
1. Ensure directory ./.codebuddy/specs/{feature_name}/ exists
2. Save the architecture to ./.codebuddy/specs/{feature_name}/02-system-architecture.md
3. Confirm successful save"
```
...
Repository Context: [Include repository scan results]
Repository Scan Path: ./.codebuddy/specs/{feature_name}/00-repo-scan.md
PRD Path: ./.codebuddy/specs/{feature_name}/01-product-requirements.md
Architecture Path: ./.codebuddy/specs/{feature_name}/02-system-architecture.md
Feature Name: {feature_name}
...
Your task:
1. Ensure directory ./.codebuddy/specs/{feature_name}/ exists
2. Save the sprint plan to ./.codebuddy/specs/{feature_name}/03-sprint-plan.md
3. Confirm successful save"
```
...
Instructions:
1. Read PRD from ./.codebuddy/specs/{feature_name}/01-product-requirements.md
2. Read Architecture from ./.codebuddy/specs/{feature_name}/02-system-architecture.md
3. Read Sprint Plan from ./.codebuddy/specs/{feature_name}/03-sprint-plan.md
...
6. Save report to ./.codebuddy/specs/{feature_name}/04-dev-reviewed.md

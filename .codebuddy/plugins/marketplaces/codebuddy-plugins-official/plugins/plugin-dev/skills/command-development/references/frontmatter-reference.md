...
**Purpose:** Specify which CodeBuddy model executes the command
...
- CodeBuddy can invoke programmatically
...
**Best practices:**
- Use sparingly (limits CodeBuddy's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid CodeBuddy model
```

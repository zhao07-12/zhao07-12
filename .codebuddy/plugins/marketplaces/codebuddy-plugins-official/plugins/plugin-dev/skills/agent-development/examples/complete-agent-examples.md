...
3. Check adherence to project best practices and coding standards from CODEBUDDY.md
...
5. **Best Practices**:
   - Follow project-specific standards from CODEBUDDY.md
...
- Missing context (no CODEBUDDY.md): Apply general best practices

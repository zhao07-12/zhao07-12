...
Simply ask questions that match an agent's focus area, and CodeBuddy will automatically trigger the appropriate agent:
...
CodeBuddy may proactively use these agents based on context:
...
- Project agents: `.codebuddy/agents/` in claude-cli-internal

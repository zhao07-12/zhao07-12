...
**CRITICAL PRINCIPLE 2**: Use CodeBuddy's DOCX and XLSX skills to programmatically create the report.

**REQUIRED TOOLS** (CodeBuddy has built-in skills for these):
...
**DO**: Use CodeBuddy's DOCX and XLSX skills to open files, extract data, and create the DOCX report
...
Use CodeBuddy's file operations to check:
...
**Open and inspect files using CodeBuddy skills:**
...
**Use CodeBuddy's XLSX skill to extract data from Excel files:**
...
Use CodeBuddy's DOCX and XLSX skills to:
...
**Throughout the entire assembly process, use CodeBuddy's DOCX and XLSX skills with actual file operations:**
...
**Do NOT manually copy/paste. Use CodeBuddy's built-in skills to:**
